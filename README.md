...
[![git branch](https://img.shields.io/badge/branch-php5-yellow)](https://github.com/GuiRong2969/php-validate/tree/1.x)
...
- 新增了独立的过滤器 `Guirong\Validate\Filter\Filtration` 用于数据过滤
...
```php
composer require guirong/php-validate ^1.0
```
...
```
"guirong/php-validate": "^1.0", // for php5
```
...
```
git clone -b 1.x https://github.com/GuiRong2969/php-validate.git
```
...
创建一个新的class，并使用 Trait `Guirong\Validate\ValidationTrait`。 此方式是高级自定义的使用方式, 可以方便的嵌入到其他类中
...
- 在继承了 `Guirong\Validate\Validation` 的子类添加验证方法. 请看上面的 [使用方式1](#how-to-use1)
