...
[![Php Version](https://img.shields.io/badge/php-%3E%3D7.1-brightgreen)](https://www.php.net/ChangeLog-7.php)
...
> **注意：** 
- master 分支是要求 `php >= 8.1` 。
- `2.x` 分支是支持 php 7 的代码分支 

## 安装

```bash
composer require guirong/php-validate ^2.0
```
