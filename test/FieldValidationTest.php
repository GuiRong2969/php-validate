...
use Guirong\Validate\FV;
use Guirong\ValidateTest\Example\FieldExample;
...
class FieldValidationTest extends TestCase
{
    ...
    {
        $rv = FieldValidation::make(['name' => 'Guirong'], [
            []
        ]);
        try {
            $rv->validate();
    ...
    /**
     * @link https://github.com/Guirong/php-validate/issues/22
     */
    ...
    /**
     * @link https://github.com/Guirong/php-validate/issues/36
     */
    ...
    /**
     * @link https://github.com/Guirong/php-validate/issues/55
     */
    public function testIssues55(): void
    {
        ...
        $validator = \Guirong\Validate\Validation::make($data, [
