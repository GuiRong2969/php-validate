...
class ValidationTraitTest extends TestCase
{
    ...
    /**
     * @var \array[][] see PR https://github.com/Guirong/php-validate/pull/19
     */
    ...
    public function testBeforeAndAfter(): void
    {
        ...
        $v->onAfterValidate(function (Validation $v) {
            $this->assertSame('Guirong', $v->getRaw('name'));
            $this->assertSame('Guirong', $v->getSafe('name'));
        });
        ...
        $v = Validation::make(['name' => 'Guirong'], [
            [
                ...
                'before' => function ($value) {
                    return $value === 'Guirong';
                },
                'after' => function ($value) {
                    $this->assertSame('Guirong', $value);
                    return true;
                }
            ]
        ]);
